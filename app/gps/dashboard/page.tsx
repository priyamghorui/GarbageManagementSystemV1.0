        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <button
              ...
              disabled
              className="w-full py-3 bg-red-600 text-white cursor-pointer disabled:bg-red-400 disabled:cursor-not-allowed disabled:opacity-75 font-medium rounded-lg hover:bg-red-700 transition duration-150 shadow-md flex items-center justify-center mt-auto"
            >
              <List className="w-5 h-5 mr-2" />
              View Complaint List
            </button>
